  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@recipefinder.com" className="text-gray-600 hover:text-primary-600 transition-colors">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-primary-600 hover:text-white transition-colors text-gray-600"
                  >
                    <FaFacebook />
                  </a>
                  <a
        ...
        {/* Additional Info */}
        <div className="mt-12 bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl shadow-xl p-8 text-white">
